...
::Reference - https://stackoverflow.com/questions/21772060/batch-file-try-catch
::Reference - https://www.dostips.com/forum/viewtopic.php?f=3&t=6497
::Reference - https://www.dostips.com/forum/viewtopic.php?p=48480#p48480
  ...
  for /l %%# in (1 1 10) do for /f "delims=" %%S in (" !exception.Stack!") do (
    ...
    if "!!" equ "" (
      ...
      if "^!^" equ "^!" (
        ...
        echo(
        echo %ESC%[31mUnhandled batch exception:%ESC%[0m
        echo   Code = %%1
        echo   Msg  = %%2
        echo   Loc  = %%3
        echo   Stack=%%S
